...
var NamespaceScope = class extends NonRootScope {
  constructor(ambient, hasExport, parent) {
    super(parent, 1 /* Function */);
    __privateAdd(this, _ambient);
    __privateAdd(this, _exports2);
    __privateAdd(this, _hasExport);
...
var BlockScope = class extends NonRootScope {
  constructor(functionScope, parent) {
    ...
    __privateAdd(this, _functionScope);
...
// src/usage/UsageWalker.ts
var _result, _scope, _UsageWalker_instances, handleBindingName_fn, handleConditionalType_fn, handleDeclaration_fn, handleFunctionLikeDeclaration_fn, handleModule_fn, handleVariableDeclaration_fn;
var UsageWalker = class {
  constructor() {
    __privateAdd(this, _UsageWalker_instances);
  ...
  getUsage(sourceFile) {
    ...
    const cb = (node) => {
      ...
      switch (node.kind) {
        ...
        case import_typescript24.default.SyntaxKind.ClassDeclaration:
          __privateMethod(this, _UsageWalker_instances, handleDeclaration_fn).call(this, node, true, 4 /* Value */ | 2 /* Type */);
          return continueWithScope(
            node,
            new NonRootScope(__privateGet(this, _scope), 1 /* Function */)
          );
        ...
        case import_typescript24.default.SyntaxKind.TypeAliasDeclaration:
          __privateMethod(this, _UsageWalker_instances, handleDeclaration_fn).call(this, node, true, 2 /* Type */);
          return continueWithScope(
            node,
            new NonRootScope(__privateGet(this, _scope), 4 /* Type */)
          );
        case import_typescript24.default.SyntaxKind.EnumDeclaration:
          __privateMethod(this, _UsageWalker_instances, handleDeclaration_fn).call(this, node, true, 7 /* Any */);
          return continueWithScope(
            node,
        ...
        case import_typescript24.default.SyntaxKind.ModuleDeclaration:
          return __privateMethod(this, _UsageWalker_instances, handleModule_fn).call(this, node, continueWithScope);
        ...
        case import_typescript24.default.SyntaxKind.FunctionType:
          return __privateMethod(this, _UsageWalker_instances, handleFunctionLikeDeclaration_fn).call(this, node, cb, variableCallback);
        case import_typescript24.default.SyntaxKind.ConditionalType:
          return __privateMethod(this, _UsageWalker_instances, handleConditionalType_fn).call(this, node, cb, variableCallback);
        // End of Scope specific handling
        case import_typescript24.default.SyntaxKind.VariableDeclarationList:
          __privateMethod(this, _UsageWalker_instances, handleVariableDeclaration_fn).call(this, node);
          break;
        case import_typescript24.default.SyntaxKind.Parameter:
          if (node.parent.kind !== import_typescript24.default.SyntaxKind.IndexSignature && (node.name.kind !== import_typescript24.default.SyntaxKind.Identifier || identifierToKeywordKind(
            ...
            __privateMethod(this, _UsageWalker_instances, handleBindingName_fn).call(this, node.name, false, false);
          }
          break;
        ...
        case import_typescript24.default.SyntaxKind.ImportEqualsDeclaration:
          __privateMethod(this, _UsageWalker_instances, handleDeclaration_fn).call(this, node, false, 7 /* Any */ | 8 /* Import */);
          break;
    ...
    const handleBlockScope = (node) => {
      if (node.kind === import_typescript24.default.SyntaxKind.CatchClause && node.variableDeclaration !== void 0) {
        __privateMethod(this, _UsageWalker_instances, handleBindingName_fn).call(this, node.variableDeclaration.name, true, false);
      }
      return import_typescript24.default.forEachChild(node, cb);
    };
...
_result = new WeakMap();
_scope = new WeakMap();
_UsageWalker_instances = new WeakSet();
...
handleFunctionLikeDeclaration_fn = function(node, cb, varCb) {
  ...
  if (node.kind === import_typescript24.default.SyntaxKind.FunctionDeclaration) {
    __privateMethod(this, _UsageWalker_instances, handleDeclaration_fn).call(this, node, false, 4 /* Value */);
  }
...
handleVariableDeclaration_fn = function(declarationList) {
  ...
  for (const declaration of declarationList.declarations) {
    __privateMethod(this, _UsageWalker_instances, handleBindingName_fn).call(this, declaration.name, blockScoped, exported);
  }
};
